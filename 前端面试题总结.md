...
eg：一段脚本只能读取来自于同一来源的窗口和文档的属性，这里的同一来源指的是主机名、协议和端口号的组合。
```
...
**7、请编写一个JavaScript函数 parseQueryString，它的用途是把URL参数解析为一个对象，**
...
**14. 说说最近最流行的一些东西吧？常去哪些网站？**

	ES6\WebAssembly\Node\MVVM\Web Components\React\React Native\Webpack 组件化

**15. 移动端（Android IOS）怎么做好用户体验?**
